...
Within the MN_outputs folder, separate sceneario folders exist for each scenario. Within the scenario folders, there is a "Biomass-succession-log.csv" file for each scenario. Fields include (copied from Biomass Succession Manual):
